...
return [
	'errors' => [
		'activity_inactive' => 'The selected activity does not exist or is inactive.', // ok
		'unit_invalid' => 'The selected unit does not exist, is inactive, or does not belong to the given branch.', // ok
		'activity_not_assigned' => 'The selected activity is not assigned to the selected unit.', // ok
		'unit_already_booked' => 'The selected unit is already booked for the given time range.', // ok
		'booking_conflict' => 'The booking conflicts with an existing reservation.', // ok
		'slot_overlap' => 'The selected booking slot overlaps an existing reservation.', // ok
		'outside_working_hours' => 'The selected booking slot is outside working hours.', // ok
		'during_time_off' => 'The selected booking slot falls within a blocked time-off period.', // ok
		'already_cancelled' => 'The booking is already cancelled.', // ok
		'cancelled_cannot_be_updated' => 'Cancelled bookings cannot be updated.', // ok
		'same_status' => 'The booking is already marked as :status.', // ok
		'use_cancel_action' => 'Use the cancel booking action to cancel a booking.', // ok
		'invalid_activity_minutes' => 'Activity minutes must be greater than zero.', // ok
		'negative_buffer_minutes' => 'Buffer minutes cannot be negative.', // ok
		'invalid_slot_block' => 'Total slot block must be greater than zero.', // ok
		'invalid_total_slot_block' => 'Total slot block must be greater than zero.',
		'invalid_time_range' => 'TimeRange start must be earlier than end.', // ok
	...
	'validation' => [
        ...
        'customer_phone_code_required' => 'Phone code email is required.',
	...
	'view' => [
        ...
        'create_description' => 'Create a new booking with address details, timezone, and activation status.',
        'edit_description' => 'Update booking details, address, timezone, and activation status.',
        ...
        'form' => [
            ...
            'available_slots_count' => 'slot(s) available',
