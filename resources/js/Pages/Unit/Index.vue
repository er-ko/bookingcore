...
const links = computed(() => props.units?.links ?? [])
                ...
                <div class="overflow-hidden rounded-3xl border border-black/10 backdrop-blur-sm dark:border-white/10">
                    ...
                    >
                        ...
                        <div class="mt-8">
                            ...
                            >
                                {{ translations.create_first_unit }}
                            </Link>
                        </div>
                    </div>

                    <template v-else>
                        <UnitTable :units="items" :translations="translations" />
