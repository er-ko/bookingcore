        ...
        <div class="space-y-6 px-6 py-6">
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <div class="space-y-2 md:col-span-2">
                    ...
                    <p v-if="form.errors.duration_minutes" class="text-sm text-red-600">
                        {{ form.errors.duration_minutes }}
                    </p>
                </div>

                <div class="space-y-2">
                    <label for="buffer_before_minutes" class="block text-sm font-medium text-gray-700">
                    ...
                    <p v-if="form.errors.buffer_before_minutes" class="text-sm text-red-600">
                        {{ form.errors.buffer_before_minutes }}
                    </p>
                </div>

                <div class="space-y-2">
                    <label for="buffer_after_minutes" class="block text-sm font-medium text-gray-700">
                    ...
                    <p v-if="form.errors.buffer_after_minutes" class="text-sm text-red-600">
