...
enum RiscEventType: string
{
    ...
    case TokenRevoked = 'https://schemas.openid.net/secevent/risc/event-type/token-revoked';
    ...
    case CredentialChangeRequired = 'https://schemas.openid.net/secevent/risc/event-type/credential-change-required';
